        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="${urlDelete}/${pelicula.id}" class="btn btn-danger btn-sm" onclick=' return (confirm("¿Estas seguro de eliminar la pelicula?")) ' role="button" title="Eliminar" ><span class="glyphicon glyphicon-trash"></span></a>
                </td>
            </tr>
            </c:forEach>
        </table>
