	...
	<div class="container theme-showcase" role="main">
		...
		<form:form action="${urlForm}" method="post" enctype="multipart/form-data" modelAttribute="pelicula">
			...
			<div class="row">
				...
				<div class="col-sm-3">
					<div class="form-group">
						<label for="duracion">Duracion</label> <form:input type="text"
				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						<form:select id="clasificacion" path="clasificacion"
							class="form-control">
							<form:option value="0">Clasificacion TP</form:option>
							<form:option value="7">Clasificacion 7</form:option>
							<form:option value="12">Clasificacion 12</form:option>
							<form:option value="16">Clasificacion 16</form:option>
							<form:option value="18">Clasificacion 18</form:option>
						</form:select>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="form-group">
						<label for="genero" class="control-label">Genero</label> <form:select
							id="genero" path="genero" class="form-control" items="${generos}">
							<%--
			...
			<div class="row">
				<div class="col-sm-3">
					<div class="form-group">
						<label for="estatus" class="control-label">Estatus</label> <form:select
							id="genero" path="status" class="form-control">
				...
				<div class="col-sm-3">
					<div class="form-group">
						<label for="fechaEstreno">Fecha Estreno</label> <form:input type="text"
